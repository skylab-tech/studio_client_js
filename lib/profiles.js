...
module.exports = function profiles(SkylabStudio) {
  ...
  // eslint-disable-next-line no-param-reassign
  SkylabStudio.prototype.createProfile = function createProfile(data, callback) {
  ...
  // eslint-disable-next-line no-param-reassign
  SkylabStudio.prototype.updateProfile = function updateProfile(data, callback) {
    const url = this._buildUrl('profiles', data.id)
  ...
  // eslint-disable-next-line no-param-reassign
  SkylabStudio.prototype.deleteProfile = function deleteProfile(data, callback) {
    const url = this._buildUrl('profiles', data.id)
